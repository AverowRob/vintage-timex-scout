...
| **E9. Shipping / landed cost** | **Gate on landed cost** (item + shipping to M6K1V8 ≤ $50); unquoted shipping kept + flagged | none | Carrier-rate estimator for fully-calculated cases (needs carrier API plus seller-location parsing) |
